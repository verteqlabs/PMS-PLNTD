...
const PatientsForm = (props) => {
  ...
  const title = () => {
    ...
    return isEditing ? 'Edit Patients' : 'Add Patients';
  };
        ...
        {(form) => (
          <form onSubmit={form.handleSubmit}>
            <Grid container spacing={3} direction='column'>
              ...
              <Grid item>
                <InputFormItem name={'last_name'} schema={patientsFields} />
              </Grid>

              <Grid item>
                <InputFormItem name={'date_of_birth'} schema={patientsFields} />
              </Grid>

              <Grid item>
                <InputFormItem name={'email'} schema={patientsFields} />
              </Grid>
              ...
              <Grid item>
                <InputFormItem name={'state'} schema={patientsFields} />
              </Grid>
              ...
              <Grid item>
                <InputFormItem name={'IHI_Number'} schema={patientsFields} />
              </Grid>
              ...
              <Grid item>
                <InputFormItem name={'occupation'} schema={patientsFields} />
              </Grid>
