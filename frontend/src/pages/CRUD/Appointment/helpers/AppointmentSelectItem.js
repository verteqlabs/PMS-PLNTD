...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/appointment/autocomplete`, { params });
  return response.data;
}

const AppointmentSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.appointment.hasPermissionToCreate
});
